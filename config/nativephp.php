...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'co.adacreative.nexus'),
    'deeplink_scheme' => env('NATIVEPHP_DEEPLINK_SCHEME', 'nexus'),
    'author' => env('NATIVEPHP_APP_AUTHOR', 'ADA Creative Co.'),
    'copyright' => env('NATIVEPHP_APP_COPYRIGHT', 'Copyright © ' . date('Y') . ' ADA Creative Co.'),
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'ADA Co-OS - Kurumsal Yönetim Platformu'),
    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://nexus.adacreative.co'),
